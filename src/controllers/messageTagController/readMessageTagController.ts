...
const readMessageTagController = async (req: CustomRequestMyTokenInJwt, res: Response, next: NextFunction) => {
    ...
    try {
        const arrayListToCheck = [ACCESS_LIST.messageTagCollection]
        ...
        const myResult = await getDataCollection(req.body,messageTag)
...
export {readMessageTagController};
